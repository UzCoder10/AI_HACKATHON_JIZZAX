...
class Scholar {
  ...
  final IconData iconData; // Replaced emoji with Sleek IconData
...
// Hardcoded scholars list with Neon-Bright accents
final List<Scholar> scholarsList = [
  const Scholar(
    ...
    solidColor: Color(0xFFFFE3B2), // Neon Gold base
    pastelColor: Color(0xFFFFF7DC),
    initials: "MU",
    iconData: Icons.nights_stay_rounded, // Astronomy Telescope/Stars replacement
  ...
  const Scholar(
    ...
    solidColor: Color(0xFF00F0FF), // Neon Cyan base
    pastelColor: Color(0xFFE3FBF7),
    initials: "AB",
    iconData: Icons.public_rounded, // Globe
  ...
  const Scholar(
    ...
    solidColor: Color(0xFFFF007A), // Cyber Pink base
    pastelColor: Color(0xFFFFECE3),
    initials: "IS",
    iconData: Icons.favorite_rounded, // Heartbeat
    ...
    fallbackResponses: [
      ...
      "Men kasalliklar ko‘zga ko‘rinmas juda kichik tirik zarrachalar (mikroblar) orqali havodan yoki suvdan o‘tishini yozganman. Shuning uchun hamisha qo‘llarni toza yuvish, toza suv ichish va gigiyenaga rioya qilish juda muhimdir.",
  ...
  const Scholar(
    ...
    solidColor: Color(0xFF3B82F6), // Blue base
    pastelColor: Color(0xFFECF1FF),
    initials: "AX",
    iconData: Icons.grid_view_rounded, // Matrix/Grid
  ...
  const Scholar(
    ...
    solidColor: Color(0xFFB89968), // Brown base
    pastelColor: Color(0xFFF9F1E7),
    initials: "IB",
    iconData: Icons.menu_book_rounded, // Hadith/Book
  ...
  const Scholar(
    ...
    solidColor: Color(0xFFC0392B), // Deep Red base
    pastelColor: Color(0xFFFFECEC),
    initials: "AT",
    iconData: Icons.shield_rounded, // Empire/Shield
